 ...
 */
package com.serotonin.mango.vo.publish.httpJsonCtcSender;
 ...
 */
@JsonRemoteEntity
public class HttpJsonCtcSenderVO extends PublisherVO<HttpJsonCtcPointVO> {
    @Override
    protected void getEventTypesImpl(List<EventTypeVO> eventTypes) {
        eventTypes.add(new EventTypeVO(EventType.EventSources.PUBLISHER, getId(), HttpJsonCtcSenderRT.SEND_EXCEPTION_EVENT,
                new LocalizableMessage("event.pb.httpSend"), AlarmLevels.URGENT));
        eventTypes.add(new EventTypeVO(EventType.EventSources.PUBLISHER, getId(), HttpJsonCtcSenderRT.RESULT_WARNINGS_EVENT,
    ...
    static {
        ...
        EVENT_CODES.addElement(HttpJsonCtcSenderRT.SEND_EXCEPTION_EVENT, "SEND_EXCEPTION_EVENT");
        EVENT_CODES.addElement(HttpJsonCtcSenderRT.RESULT_WARNINGS_EVENT, "RESULT_WARNINGS_EVENT");
    }
    ...
    @Override
    public Type getType() {
        return PublisherVO.Type.HTTPJsonCtc_SENDER;
    }

    @Override
    public PublisherRT<HttpJsonCtcPointVO> createPublisherRT() {
        return new HttpJsonCtcSenderRT(this);
    }

    @Override
    protected HttpJsonCtcPointVO createPublishedPointInstance() {
        return new HttpJsonCtcPointVO();
    }
    ...
    public void validate(DwrResponseI18n response) {
        ...
        for (HttpJsonCtcPointVO point : points) {
