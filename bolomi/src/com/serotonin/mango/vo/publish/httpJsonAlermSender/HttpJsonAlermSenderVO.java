 ...
 */
package com.serotonin.mango.vo.publish.httpJsonAlermSender;
...
import com.serotonin.mango.rt.publish.httpJsonAlermSender.HttpJsonAlermSenderRT;
 ...
 */
@JsonRemoteEntity
public class HttpJsonAlermSenderVO extends PublisherVO<HttpJsonAlermPointVO> {
    @Override
    protected void getEventTypesImpl(List<EventTypeVO> eventTypes) {
        eventTypes.add(new EventTypeVO(EventType.EventSources.PUBLISHER, getId(), HttpJsonAlermSenderRT.SEND_EXCEPTION_EVENT,
                new LocalizableMessage("event.pb.httpSend"), AlarmLevels.URGENT));
        eventTypes.add(new EventTypeVO(EventType.EventSources.PUBLISHER, getId(), HttpJsonAlermSenderRT.RESULT_WARNINGS_EVENT,
    ...
    static {
        ...
        EVENT_CODES.addElement(HttpJsonAlermSenderRT.SEND_EXCEPTION_EVENT, "SEND_EXCEPTION_EVENT");
        EVENT_CODES.addElement(HttpJsonAlermSenderRT.RESULT_WARNINGS_EVENT, "RESULT_WARNINGS_EVENT");
    }
    ...
    @Override
    public Type getType() {
        return PublisherVO.Type.HTTPJsonAlerm_SENDER;
    }

    @Override
    public PublisherRT<HttpJsonAlermPointVO> createPublisherRT() {
        return new HttpJsonAlermSenderRT(this);
    }

    @Override
    protected HttpJsonAlermPointVO createPublishedPointInstance() {
        return new HttpJsonAlermPointVO();
    }
    ...
    @JsonRemoteProperty
    boolean sendFreShot=false;

	public boolean isSendFreShot() {
		return sendFreShot;
	}

	public void setSendFreShot(boolean sendFreShot) {
		this.sendFreShot = sendFreShot;
	}
	...
	@JsonRemoteProperty
	int sendType=Common.TIME_PERIOD_CODES.getId(1);
	@JsonRemoteProperty
    int sendValue=0;
    ...
    public void validate(DwrResponseI18n response) {
        ...
        for (HttpJsonAlermPointVO point : points) {
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
        ...
        out.writeBoolean(sendFreShot);
        out.writeInt(sendType);
        out.writeInt(sendValue);
    }
    ...
    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        if (ver == 1) {
            ...
            sendFreShot=in.readBoolean();
            sendType=in.readInt();
            sendValue=in.readInt();
        }
        else if (ver == 2) {
            url = SerializationHelper.readSafeUTF(in);
            usePost = in.readBoolean();
    ...
    public void jsonSerialize(Map<String, Object> map) {
        ...
        map.put("sendFreShot", sendFreShot);
    ...
    public void jsonDeserialize(JsonReader reader, JsonObject json) throws JsonException, LocalizableJsonException {
        ...
        String obj1=json.getString("isSendFre");
        if(obj1!=null)
        {
        	sendFreShot=Boolean.getBoolean(text);
        }
        String obj2=json.getString("sendType");
        if(obj1!=null)
        {
        	sendType=Common.TIME_PERIOD_CODES.getId(text);
        }
        String obj3=json.getString("isSendFre");
        if(obj1!=null)
        {
        	sendValue=Integer.getInteger(text);
        }
    }
}
