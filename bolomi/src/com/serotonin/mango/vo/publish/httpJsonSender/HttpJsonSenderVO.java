 ...
 */
package com.serotonin.mango.vo.publish.httpJsonSender;
...
import com.serotonin.mango.rt.publish.httpJsonSender.HttpJsonSenderRT;
 ...
 */
@JsonRemoteEntity
public class HttpJsonSenderVO extends PublisherVO<HttpJsonPointVO> {
    @Override
    protected void getEventTypesImpl(List<EventTypeVO> eventTypes) {
        eventTypes.add(new EventTypeVO(EventType.EventSources.PUBLISHER, getId(), HttpJsonSenderRT.SEND_EXCEPTION_EVENT,
                new LocalizableMessage("event.pb.httpSend"), AlarmLevels.URGENT));
        eventTypes.add(new EventTypeVO(EventType.EventSources.PUBLISHER, getId(), HttpJsonSenderRT.RESULT_WARNINGS_EVENT,
    ...
    static {
        ...
        EVENT_CODES.addElement(HttpJsonSenderRT.SEND_EXCEPTION_EVENT, "SEND_EXCEPTION_EVENT");
        EVENT_CODES.addElement(HttpJsonSenderRT.RESULT_WARNINGS_EVENT, "RESULT_WARNINGS_EVENT");
    }
    ...
    @Override
    public Type getType() {
        return PublisherVO.Type.HTTPJson_SENDER;
    }

    @Override
    public PublisherRT<HttpJsonPointVO> createPublisherRT() {
        return new HttpJsonSenderRT(this);
    }

    @Override
    protected HttpJsonPointVO createPublishedPointInstance() {
        return new HttpJsonPointVO();
    }
    ...
    public void validate(DwrResponseI18n response) {
        ...
        for (HttpJsonPointVO point : points) {
