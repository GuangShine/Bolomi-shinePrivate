...
abstract public class PublisherVO<T extends PublishedPointVO> implements Serializable, JsonSerializable {
    public enum Type {
        ...
        }, HTTPJson_SENDER(4, "publisherEdit.httpJsonSender") {
            @Override
            public PublisherVO<?> createPublisherVO() {
                return new HttpJsonSenderVO();
            }
            
            
        }, HTTPJsonCtc_SENDER(6, "publisherEdit.httpJsonCtcSender") {
            @Override
            public PublisherVO<?> createPublisherVO() {
                return new HttpJsonCtcSenderVO();
            }
            
            
        },HTTPJsonAlerm_SENDER(5,"publisherEdit.httpJsonAlermSender")
        {
        	@Override
            public PublisherVO<?> createPublisherVO() {
                return new HttpJsonAlermSenderVO();
        }
        },HTTPJsonHeartbeatCtc_SENDER(7, "publisherEdit.httpJsonCtcHeartbeatSender") {
            @Override
            public PublisherVO<?> createPublisherVO() {
                return new HttpJsonCtcHeartbeatSenderVO();
        }};
