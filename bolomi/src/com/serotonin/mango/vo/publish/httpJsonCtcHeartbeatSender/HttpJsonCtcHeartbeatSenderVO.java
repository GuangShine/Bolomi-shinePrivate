 ...
 */
package com.serotonin.mango.vo.publish.httpJsonCtcHeartbeatSender;
...
import com.serotonin.mango.rt.publish.httpJsonCtcHeartbeatSender.HttpJsonCtcHeartbeatSenderRT;
import com.serotonin.mango.rt.publish.httpJsonCtcSender.HttpJsonCtcSenderRT;
 ...
 */
@JsonRemoteEntity
public class HttpJsonCtcHeartbeatSenderVO extends PublisherVO<HttpJsonCtcHeartbeatPointVO> {
    @Override
    protected void getEventTypesImpl(List<EventTypeVO> eventTypes) {
        eventTypes.add(new EventTypeVO(EventType.EventSources.PUBLISHER, getId(), HttpJsonCtcHeartbeatSenderRT.SEND_EXCEPTION_EVENT,
                new LocalizableMessage("event.pb.httpSend"), AlarmLevels.URGENT));
        eventTypes.add(new EventTypeVO(EventType.EventSources.PUBLISHER, getId(), HttpJsonCtcHeartbeatSenderRT.RESULT_WARNINGS_EVENT,
    ...
    static {
        ...
        EVENT_CODES.addElement(HttpJsonCtcHeartbeatSenderRT.SEND_EXCEPTION_EVENT, "SEND_EXCEPTION_EVENT");
        EVENT_CODES.addElement(HttpJsonCtcHeartbeatSenderRT.RESULT_WARNINGS_EVENT, "RESULT_WARNINGS_EVENT");
    }
    ...
    @Override
    public Type getType() {
        return PublisherVO.Type.HTTPJsonHeartbeatCtc_SENDER;
    }

    @Override
    public PublisherRT<HttpJsonCtcHeartbeatPointVO> createPublisherRT() {
        return new HttpJsonCtcHeartbeatSenderRT(this);
    }

    @Override
    protected HttpJsonCtcHeartbeatPointVO createPublishedPointInstance() {
        return new HttpJsonCtcHeartbeatPointVO();
    }
	...
	@JsonRemoteProperty
	int heartBeatType=Common.TIME_PERIOD_CODES.getId(1);
	...
	public void setHeartBeatValue(int heartBeatValue) {
    ...
    public void validate(DwrResponseI18n response) {
        ...
        for (HttpJsonCtcHeartbeatPointVO point : points) {
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
        ...
        out.writeInt(heartBeatType);
        out.writeInt(heartBeatValue);
    }
    ...
    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        if (ver == 1) {
            ...
            heartBeatType=in.readInt();
            heartBeatValue=in.readInt();
        }
        else if (ver == 2) {
            url = SerializationHelper.readSafeUTF(in);
            usePost = in.readBoolean();
    ...
    public void jsonSerialize(Map<String, Object> map) {
        ...
        map.put("heartBeatType", heartBeatType);
        map.put("heartBeatValue",heartBeatValue);
