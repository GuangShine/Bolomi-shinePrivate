...
import com.serotonin.web.i18n.Utf8ResourceBundleControl;
...
public class Common {
    ...
    public static final Utf8ResourceBundleControl CONTROL = new Utf8ResourceBundleControl();
        ...
        if (systemLanguage == null) {
            synchronized (i18nLock) {
                if (systemLanguage == null) {
                    ...
                    systemBundle = ResourceBundle.getBundle("messages", locale, CONTROL);
                }
            }
        }
    }
    ...
    public static List<KeyValuePair> getLanguages() {
        ...
        ResourceBundle i18n = ResourceBundle.getBundle("i18n", CONTROL);
