...
public class SystemSettingsDao extends BaseDao {
    ...
    public void setValue(final String key, final String value) {
        ...
        getTransactionTemplate().execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                if (value != null)
                    ejt2.update("insert into systemSettings values (?,?,?)", new Object[] { key, value,mangocode });
            }
        });
    }
    ...
    static {
        ...
        DEFAULT_VALUES.put(EMAIL_FROM_NAME, "Bolomi M2M");
        ...
        DEFAULT_VALUES.put(INSTANCE_DESCRIPTION, "BOLOMI由中科云创（北京）科技有限公司提供技术支持");
