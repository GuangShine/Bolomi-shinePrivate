...
public class ScheduledEventDao extends BaseDao {
    ...
    public List<ScheduledEventVO> getScheduledEventsByTj(String alias) {
        return query(SCHEDULED_EVENT_SELECT + " where alias like '%"+alias+"%' order by scheduleType", new ScheduledEventRowMapper());
    }
