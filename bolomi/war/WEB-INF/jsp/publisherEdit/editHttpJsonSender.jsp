...
/*       
  ...
  function savePublisherImpl(name, xid, enabled, cacheWarningSize, changesOnly, sendSnapshot, snapshotSendPeriods,
      ...
      PublisherEditDwr.saveHttpJsonSender(name, xid, enabled, points, $get("url"), $get("usePost") == "true", 
  ...
  function httpSendTest() {
      ...
      PublisherEditDwr.httpJsonSenderTest($get("url"), $get("usePost") == "true", staticHeaderList, staticParameterList,
    		  httpSendTestCB);
  }
  ...
  function httpSendTestUpdate() {
      PublisherEditDwr.httpJsonSenderTestUpdate(httpSendTestUpdateCB);
  }
