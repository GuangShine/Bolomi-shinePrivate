...
/*       
  ...
  function savePublisherImpl(name, xid, enabled, cacheWarningSize, changesOnly, sendSnapshot, snapshotSendPeriods,
      ...
      PublisherEditDwr.saveHttpJsonCtcSender(name, xid, enabled, points, $get("url"), $get("usePost") == "true", 
    		  staticHeaderList, staticParameterList, cacheWarningSize, changesOnly, $get("raiseResultWarning"),
    		  $get("dateFormat"), sendSnapshot, snapshotSendPeriods, snapshotSendPeriodType,$get("sendFre"), $get("SendFrePeriodType"),
              $get("SendFrePeriods"),savePublisherCB);
  }
    ...
    <td valign="top">
      <div class="borderDiv marR marB">
        <table>
          ...
          <tr>
              <td class="formLabelRequired">sendFre</td>
