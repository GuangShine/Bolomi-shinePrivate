...
--%>
<%@page import="com.serotonin.mango.vo.publish.httpJsonAlermSender.HttpJsonAlermSenderVO" %>
...
/*       
  ...
  function savePublisherImpl(name, xid, enabled, cacheWarningSize, changesOnly, sendSnapshot, snapshotSendPeriods,
      ...
      PublisherEditDwr.saveHttpJsonAlermSender(name, xid, enabled, points, $get("url"), $get("usePost") == "true", 
  ...
  function httpSendTest() {
      ...
      PublisherEditDwr.httpJsonAlermSenderTest($get("url"), $get("usePost") == "true", staticHeaderList, staticParameterList,
    		  httpSendTestCB);
  }
  ...
  function httpSendTestUpdate() {
      PublisherEditDwr.httpJsonAlermSenderTestUpdate(httpSendTestUpdateCB);
  }
          ...
          <tr>
            ...
            <td class="formField">
              <sst:select id="dateFormat" value="${publisher.dateFormat}">
                <sst:option value="<%= Integer.toString(HttpJsonAlermSenderVO.DATE_FORMAT_BASIC) %>"><fmt:message key="publisherEdit.httpSender.dateFormat.basic"/></sst:option>
                <sst:option value="<%= Integer.toString(HttpJsonAlermSenderVO.DATE_FORMAT_TZ) %>"><fmt:message key="publisherEdit.httpSender.dateFormat.tz"/></sst:option>
                <sst:option value="<%= Integer.toString(HttpJsonAlermSenderVO.DATE_FORMAT_UTC) %>"><fmt:message key="publisherEdit.httpSender.dateFormat.utc"/></sst:option>
              </sst:select>
            </td>
          </tr>
        </table>
