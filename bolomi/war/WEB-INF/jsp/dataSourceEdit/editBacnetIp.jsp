...
<script type="text/javascript">
  ...
  function saveDataSourceImpl() {
      DataSourceEditDwr.saveBACnetIpDataSource($get("dataSourceName"), $get("dataSourceXid"), $get("updatePeriods"),
              ...
              $get("maxReadMultipleReferencesSegmented"), $get("maxReadMultipleReferencesNonsegmented"),$get("keytype_datasource"),
              saveDataSourceCB);
  }
  ...
  function savePointImpl(locator) {
      ...
      DataSourceEditDwr.saveBACnetIPPointLocator(currentPoint.id, $get("xid"), $get("name"), $get("keytype_point"),locator, savePointCB);
  }
