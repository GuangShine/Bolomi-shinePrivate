...
<tag:page dwr="EventsDwr" onload="init">
  ...
  <script type="text/javascript">
   ...
   <div class="borderDiv" style="float:left;">
      ...
      <table>
        ...
        <tr>
         <td class="formLabel"><fmt:message key="events.id"/></td>
          <td colspan="2"  class="formField"><input id="eventId" type="text"></td>
         
       	   <td class="formLabel"><fmt:message key="events.search.keywords"/></td>
          <td colspan="2" class="formField"><input id="keywords" type="text"/></td>
            
        </tr>      
        <tr>
        <td  class="formLabel"><fmt:message key="events.search.dateRange"/></td>
          <td colspan="5" class="formField">
            <table>
              <tr><td>
  ...
  <br />
  <div class="borderDiv marB" style="clear:left;float:left;">
