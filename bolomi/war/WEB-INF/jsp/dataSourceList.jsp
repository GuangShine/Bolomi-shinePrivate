...
<tag:page dwr="DataSourceListDwr" onload="init">
  <script>
    ...
    //new 
    function ExprotDataSource(fromDataSourceId)
    {
    	DataSourceListDwr.createExportData(fromDataSourceId, function(data){
    		var strdata=data;
            var reg=new RegExp("\"chartRenderer\":null,","g"); 
            var newstr=strdata.replace(reg,"");        
        	$set("emportData", newstr);
    	} );
    }
    ...
    function doImport() {
        ...
        $set("alternateMessage", "Import DataMessage...");
        DataSourceListDwr.importData($get("emportData"), function(response) {
            if (response.data.importStarted)
                ...
                $set("alternateMessage", "No DataMessage");
                setDisabled("importBtn", false);
            }
        });
    }
    ...
    function importUpdate() {
    	DataSourceListDwr.importUpdate(function(response) {
  ...
  <table cellspacing="0" cellpadding="0">
    ...
    <tr>
                ...
                <c:forEach items="${paging.data}" var="listParent" begin="${paging.offset}" end="${paging.endIndex}">
                  <tr class="row" id="dataSourceRow${listParent.parent.id}">
                    ...
                    <td>
                      ...
                      <tag:img png="icon_ds_go" title="Emport DataSource" id="ExprotDataSourceImg${listParent.parent.id}" 
                              onclick="ExprotDataSource(${listParent.parent.id})"/>   
                    </td>
                  </tr>
      ...
      <td>
   <%--      <div class="borderDiv marB" style="float:right;">
    <table width="100%">
      <tr><td><span class="smallTitle">Import DataSource</span></td></tr>
      <tr>
        <td>
          <fmt:message key="emport.importInstruction"/>
          <input id="importBtn" type="button" value="Import" onclick="doImport()"/>
  ...
  <!--  <div style="clear:both;">
    <span class="formLabelRequired">DataSource Content</span><br/>
