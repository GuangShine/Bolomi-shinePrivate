      ...
      <div dojoType="SplitContainer" orientation="horizontal" sizerWidth="3" activeSizing="true" class="borderDiv"
        ...
        <div dojoType="ContentPane" sizeMin="50" sizeShare="50" style="overflow:auto; padding:2px 10px 2px 2px;">
          <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
              <td class="smallTitle"><fmt:message key="watchlist.watchlist"/>
               ...
               <tag:help id="watchList"/></td>
              <td align="right">
               
                <div>
                <div id="wlEditDiv" style="display:inline;" onmouseover="showWatchListEdit()">
                  <tag:img id="wlEditImg" png="new_edit" title="watchlist.editListName"/>
                ...
                <div id="usersEditDiv" style="display:none;" onmouseover="showWatchListUsers()">
                  <tag:img png="one_user" title="share.sharing" onmouseover="closeLayers();"/>
                ...
                <tag:img png="new_copy" onclick="addWatchList(true)" title="watchlist.copyList" onmouseover="closeLayers();"/>
                <tag:img png="new_add" onclick="addWatchList(false)" title="watchlist.addNewList" onmouseover="closeLayers();"/>
                <tag:img png="new_delete2" id="watchListDeleteImg" onclick="deleteWatchList()" title="watchlist.deleteList"
