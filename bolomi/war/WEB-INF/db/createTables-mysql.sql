...
create table mangoServers(
 id int(11) NOT NULL AUTO_INCREMENT,
  code varchar(50) DEFAULT NULL,
  name varchar(50) DEFAULT NULL,
  serverurl varchar(255) DEFAULT NULL,
  serveradmin varchar(255) DEFAULT NULL,
  serverpwd varchar(255) DEFAULT NULL,
primary key(id)
)engine=InnoDB;
--
-- System settings
...
CREATE TABLE pointcode (
  ...
  code_format varchar(32) NOT NULL,
...
INSERT INTO pointcode VALUES ('point', '<NUM>', '1', '5', '2015-01-01 00:00:00');
INSERT INTO pointcode VALUES ('datasources','<NUM>','1','5','2015-01-01 00:00:00');
INSERT INTO pointcode VALUES ('key_code','<NUM>','1','5','2015-01-01 00:00:00');
--
--
-- Views
--
...
CREATE TABLE keies (
  ...
  Key_cTime varchar(64) NOT NULL,
  Key_uTime varchar(64) DEFAULT NULL,
  PRIMARY KEY (Id)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
INSERT INTO keies (Key_Code,Key_Name,Key_cTime,Key_uTime) VALUES ( 'KEYTYPE_00001', 'machine', '2015-05-14', null);
CREATE TABLE key_lk (
  Id int(11) NOT NULL,
  Key_Code varchar(32) NOT NULL,
  Ref_Code varchar(32) NOT NULL,
  MangoCode varchar(32) NOT NULL,
  KeyType int(11) NOT NULL,
  Key_Check int(11) unsigned zerofill DEFAULT NULL,
  Key_lk_cTime varchar(64) NOT NULL,
  Key_lk_uTime varchar(64) DEFAULT NULL,
  PRIMARY KEY (Id)
) ENGINE=InnoDB;
