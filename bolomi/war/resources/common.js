...
function setUserMuted(muted) {
    ...
    if (muted)
        updateImg(imgNode, "images/sound_none.png", mango.i18n["header.unmute"], true, "inline");
    else
        updateImg(imgNode, "images/sound_mute.png", mango.i18n["header.mute"], true, "inline");
}
